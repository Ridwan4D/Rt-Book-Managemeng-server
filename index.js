...
app.use(cors({
  origin: ['http://localhost:5173', 'http://localhost:5174', "https://rt-library-management-118f5.web.app", "https://rt-library-management.web.app", "https://rt-library-management-118f5.firebaseapp.com"],
  credentials: true,
}));
...
async function run() {
  try {
    ...
    app.post("/addBooks",logger, async (req, res) => {
    ...
    app.get("/allBorrowBooks/:email",logger,verifyToken, async (req, res) => {
